...
def save_cam(torch_img, grad_cam_map, index, conf = False):
    ...
    if conf == False:
        save_image(grad_result,'C:/Users/rhtn9/OneDrive/바탕 화면/code/ICASC++/result/plus(256)_NIH/result{}_true.png'.format(index))
    else:
        save_image(grad_result,'C:/Users/rhtn9/OneDrive/바탕 화면/code/ICASC++/result/plus(256)_NIH/result{}_false.png'.format(index))
